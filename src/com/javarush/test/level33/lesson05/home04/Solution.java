...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        System.out.println(jsonString+"=="+one.getClass().getSimpleName()+"+"+resultClassObject.getSimpleName());
        /*{"className":"first","i":0,"name":null}==First+Second
        {"className":"second","i":0,"name":null}==Second+First
        Без аннотаций
        {"i":0,"name":null}==First+Second
        {"i":0,"name":null}==Second+First
        без @JsonSubTypes(@JsonSubTypes.Type(value=First.class,  name="first"))
        {"className":"Solution$First","i":0,"name":null}==First+Second
        */
