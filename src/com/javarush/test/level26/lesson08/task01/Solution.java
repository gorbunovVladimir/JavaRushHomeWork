...
public class Solution {
    ...
    {   private int a;
        ...
        /*если одна нить вызовет метод get в то время когда другая работает в методе set вы получите совсем не предсказуемый результат*/
        synchronized public void set(int a){this.a = a;}
    }
