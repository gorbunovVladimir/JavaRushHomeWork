...
public class Solution extends Thread {
    ...
    public Solution(Runnable runnable) {this(runnable, DEFAULT_JAVARUSH_THREAD_NAME);}//1

    public Solution(Runnable runnable, String name) {
        super(runnable, name + "-" + createdThreadIndex.incrementAndGet());//2
    ...
    public void run() {
        ...
        try {
            System.out.println("3"+this.getName());//
