...
/*Сама строка «select * from SUBSCRIPTION» это пример SQL запроса. SQL — язык запросов к базе данных.
Рекомендую познакомиться с этим языком, так как понимание этого понадобится в программировании. Но для решения данной задачи его знать не требуется, нужно только сформировать строки по примеру из задания.*/