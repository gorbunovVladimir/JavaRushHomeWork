...
public abstract class AbstractDbSelectExecutor<T extends NamedItem> {
    ...
    private T getNewInstanceOfGenericType() throws InstantiationException, IllegalAccessException {
        ...
        //com.javarush.test.level23.lesson08.home01.AbstractDbSelectExecutor<com.javarush.test.level23.lesson08.home01.vo.User>
        //class com.javarush.test.level23.lesson08.home01.vo.User
