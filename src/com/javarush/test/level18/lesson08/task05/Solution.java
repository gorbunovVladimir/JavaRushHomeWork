...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface
    {
        ...
        public String getHeaderText(){return aTableInterface.getHeaderText().toUpperCase();}

        public void setHeaderText(String newHeaderText){aTableInterface.setHeaderText(newHeaderText);}
    }
