...
public class Solution {
    ...
    private boolean fileLoaded;/*Здесь is не надо было дописывать. Да, мы так делали в уроках и там говорилось, что так принято, но в конвенции об этом ни слова, потому просто как обычную переменную именуем.*/
