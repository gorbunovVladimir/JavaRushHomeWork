...
//Я качестве констант рассматривал только неизменные объекты и примитивы. Так ведь константа только ссылка на объект, но не сам объект.
...
/*метод, который вставит пару (randomInt, text) только для ключа, которого нет в concurrentMap.
Метод должен возвращать предыдущее значение либо null для новой пары.*/
