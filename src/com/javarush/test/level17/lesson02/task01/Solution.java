...
public class Solution {
    public static void main(String[] args) {
       /* Thread t1 = new Thread(new NoteThread());
        ...
        NoteThread t1=new NoteThread();NoteThread t2=new NoteThread();
        t1.start();
        t2.start();
    }

    public static class NoteThread extends Thread  {//implements Runnable
    ...
    public static class Note {
        ...
        public static void removeNote(String threadName) {
            ...
            String note = notes.remove(0);//System.out.println(note+"------------");
            if (note == null) {
