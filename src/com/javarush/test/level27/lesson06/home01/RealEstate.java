...
public class RealEstate {
    ...
    public void up(Apartment apartment) {//synchronized
    ...
    public void revalidate() {//synchronized
        ...
        Set<Apartment> allApartmentsCopy;
        synchronized (allApartments){allApartmentsCopy=allApartments;}
        for (Apartment apartment : allApartmentsCopy) {
