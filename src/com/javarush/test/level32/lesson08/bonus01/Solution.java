...
public class Solution {
    ...
    public <T extends Item> T  getProxy(Class<T> itemClass,Class ...interfaces) {
        ...
        _interfaces[0] = itemClass;
        System.arraycopy(interfaces, 0, _interfaces, 1, interfaces.length);
/*В аргументах arraycopy() передается исходный массив, начальная позиция копирования в исходном массиве,
 приёмный массив, начальная позиция копирования в приёмном массиве и количество копируемых элементов.
 Любое нарушение границ массива приведет к исключению.
 */
