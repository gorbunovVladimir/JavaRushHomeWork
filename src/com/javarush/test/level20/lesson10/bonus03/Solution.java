...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        //List<Word> listing = detectAllWords(crossword, "home", "same");
        List<Word> listing = detectAllWords(crossword, "pm","homed", "home", "same", "fulmp", "fsg", "r", "rr", "gsf", "dsnl", "mluf", "rrj", "rplm", "hvok", "a", "prek", "eoln", "mpds");
        for (Word word : listing) {System.out.println(word);}
        /*
Ожидаемый результат
home - (5, 3) - (2, 0)
same - (1, 1) - (4, 1)
