...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        //Add your code here
        LinkedBlockingQueue<Runnable> lk=new LinkedBlockingQueue<>();
        for(int i=1; i<11; i++){
            final int localId = i;
            lk.put(new Runnable()
            {
        ...
        ThreadPoolExecutor mj=new ThreadPoolExecutor(3,5,1000,TimeUnit.MILLISECONDS,lk);
        mj.prestartAllCoreThreads();
        mj.shutdown();
        mj.awaitTermination(5,TimeUnit.SECONDS);
        /* output example
