...
public class Solution {
    ...
    static {BufferedReader reader=new BufferedReader(new InputStreamReader(System.in));
        try{ firstFileName=reader.readLine();secondFileName=reader.readLine();reader.close();}
        catch (IOException e){}
    }
    ...
    {   String fullFileName="";
        ...
        public void run() {
            ...
            {BufferedReader reader2=new BufferedReader(new FileReader(fullFileName));
                while((s=reader2.readLine())!=null)  {n+=s+ " ";}
                reader2.close();
            }
        ...
        public String getFileContent(){return n.trim();}
