...
public class Solution {
   ...
   /* public static class GenerateThread extends Thread{
        private static volatile int countCreatedThreads=1;

        public GenerateThread() {
            super(String.valueOf(++countCreatedThreads));start();}
            @Override
            public String toString(){return getName() + " created";}
        public void run() {//System.out.println(this);
            for (;countCreatedThreads<Solution.count;){System.out.println(Thread.currentThread());new GenerateThread();}
        }
        }*/
