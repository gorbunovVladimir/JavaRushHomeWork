...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("#1:" + consolReader1); //System.out.println("#1:" + consolReader1.result.toString().substring(1, consolReader1.result.toString().length()-1));
        System.out.println("#2:" + consolReader2); //System.out.println("#2:" + consolReader2.result.toString().substring(1, consolReader2.result.toString().length()-1));
        System.out.println("#3:" + consolReader3); //System.out.println("#3:" + consolReader3.result.toString().substring(1, consolReader3.result.toString().length()-1));
    ...
    public static class ReaderThread extends Thread {
        ...
        public void run() {
            ...
            try
            {
                result.add(reader.readLine());++countReadStrings;
            }
            catch (IOException e)
            {
        ...
        public String toString() {
            String s = result.toString();//return s;
