...
public class Solution {
    ...
    public static int calculateHorsesFinished(List<Horse> horses) throws InterruptedException {
        ...
        {if (!horses.get(i).isFinished){System.out.println("Waiting for " + horses.get(i).getName());horses.get(i).join();}
        else {countFinished++ ;}}
    ...
    public static List<Horse> prepareHorsesAndStart() {
        List<Horse> horses = new ArrayList<Horse>(countHorses);//(countHorses)
        String number;
